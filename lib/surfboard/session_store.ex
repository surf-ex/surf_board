defmodule Surfboard.SessionStore do
  ...
  # Surfboard sessions. The Transport actors register themselves on
  # init and unregister on terminate.
  #
  # Useful for a supervisor/orchestrator process that wants to find and
  # close every session owned by some crashed/restarted worker pid.
  #
