defmodule Surfboard.OpsShared do
  ...
  @xpath_polyfill_path Path.join(:code.priv_dir(:surfboard), "cdp/wgxpath.install.js")
  ...
  # priv/surfboard.js as the W.run interpreter (W.text, W.attribute,
  ...
  defmacro __using__(_opts) do
    ...
    quote do
      ...
      priv/surfboard.js — returns one of `"patch"`, `"navigate"`,
      `"full_page"`, or `"none"`.
      """
