defmodule SurfBoard.Clients.BiDi.ResponseParser do
  @moduledoc false
  ...
  @doc """
  Converts BiDi element nodes into SurfBoard Element structs.
  """
  def cast_elements(parent, nodes) do
    Enum.map(nodes, fn {shared_id, node} ->
      ...
      Process.put({:surf_board_element_shared_id, backend_node_id}, shared_id)
  ...
  returned. This is needed when multiple surf_board sessions share a
