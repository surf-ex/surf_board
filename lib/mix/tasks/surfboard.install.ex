defmodule Mix.Tasks.Surfboard.Install do
  ...
  ## Usage
      ...
      mix surfboard.install              # all browsers, latest stable Chrome
      mix surfboard.install 147.0.7727   # all browsers, specific Chrome version

  To install just one browser, use the scoped subtasks:

      mix surfboard.install.chrome       # Chrome for Testing + chromium-bidi deps
      mix surfboard.install.lightpanda   # Lightpanda only
