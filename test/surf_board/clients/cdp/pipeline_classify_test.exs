defmodule SurfBoard.Clients.CDP.PipelineClassifyTest do
  ...
  # Wallabidi.Remote.CDP.Pipeline (now deleted). priv/surf_board.js is the
  ...
  # priv/surf_board.js. Returns the function expression as a standalone
  ...
  defp run_classify(dom_setup_js, el_expr, type) do
    ...
    path =
      Path.join(System.tmp_dir!(), "surf_board_classify_#{System.unique_integer([:positive])}.js")
