defmodule SurfBoard.BrowserPathsTest do
  ...
  describe "lightpanda/0" do
    test "resolves SURF_BOARD_LIGHTPANDA_PATH when the file exists" do
    ...
    test "a missing SURF_BOARD_LIGHTPANDA_PATH file does not resolve to that path" do
    ...
    test "an empty SURF_BOARD_LIGHTPANDA_PATH is treated as unset" do
      System.put_env(@env, "")
