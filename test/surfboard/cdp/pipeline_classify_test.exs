defmodule Surfboard.CDP.PipelineClassifyTest do
  ...
  # Tests `W.classify` from priv/surfboard.js — the production classifier
  ...
  # Wallabidi.Remote.CDP.Pipeline (now deleted). priv/surfboard.js is the
  # single source of truth.

  @moduletag :classifier

  @bundle_path Path.expand("../../../priv/surfboard.js", __DIR__)
  ...
  # priv/surfboard.js. Returns the function expression as a standalone
  ...
  defp run_classify(dom_setup_js, el_expr, type) do
    ...
    path =
      Path.join(System.tmp_dir!(), "surfboard_classify_#{System.unique_integer([:positive])}.js")
