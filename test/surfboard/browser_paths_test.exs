defmodule Surfboard.BrowserPathsTest do
  ...
  describe "lightpanda/0" do
    test "resolves SURFBOARD_LIGHTPANDA_PATH when the file exists" do
    ...
    test "a missing SURFBOARD_LIGHTPANDA_PATH file does not resolve to that path" do
    ...
    test "an empty SURFBOARD_LIGHTPANDA_PATH is treated as unset" do
      System.put_env(@env, "")
